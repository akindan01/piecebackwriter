    ...
    <>
      ...
      <div className="min-h-screen w-full bg-white">
        ...
        >
          ...
          {/* Tagline */}
          <p className="text-2xl md:text-3xl font-medium mt-4 text-gray-700 italic reveal">
        ...
        <section
          id="Community"
          className="reveal bg-white min-h-screen w-full px-6 md:px-20 py-12 text-center"
        >
          <div className="max-w-4xl mx-auto reveal">
            <h2 className="text-5xl md:text-6xl font-serif font-bold text-black text-center mb-6">
              Join The Community
            </h2>
            <p className="text-gray-600 text-center mb-10">
              Be the first to receive fresh poems, updates, and connect with fellow writers.
            </p>

            {!submitted ? (
              <form
                className="max-w-3xl mx-auto flex flex-col gap-6 reveal"
              ...
              <div className="mt-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    href="https://chat.whatsapp.com/Dr7BnwOuwOSOQJsShVIPye?mode=ems_copy_t"
                    target="_blank"
